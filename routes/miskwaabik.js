...
const miskwaabik = express.Router();
...
miskwaabik.get("/addMiskwaabik", function (req, res) {
    /*
    ...
    book = {
        ...
        thumbnail: "https://storage.googleapis.com/sacred-records/books/miskwaabik/miskwaabik-thumbnail.jpg",
...
miskwaabik.get("/removeMiskwaabik", function (req, res) {
